...
/**
 * \file        htdocs/modulebuilder/template/class/typeappetence.class.php
 * \ingroup     mymodule
 ...
 * Class for MyObject
 */
class TypeAppetence extends CommonObject
{
	/**
	 ...
	 */
	public $element = 'typeappetence';

	/**
	 * @var string Name of table without prefix where object is stored. This is also the key used for extrafields management.
	 */
	public $table_element = 'management_c_type_appetence';
	...
	'type'=>array('type'=>'varchar(255)', 'label'=>'Type', 'enabled'=>1, 'visible'=>-1, 'notnull'=>1, 'position'=>15),
	'active'=>array('type'=>'integer', 'label'=>'Active', 'enabled'=>1, 'visible'=>-1, 'position'=>20),
	);
// END MODULEBUILDER PROPERTIES
	...
	public function getNomUrl($withpicto = 0, $option = '', $notooltip = 0, $morecss = '', $save_lastsearch_value = -1)
	{
		...
		$url = dol_buildpath('/management/typeappetence_card.php', 1).'?id='.$this->id;
